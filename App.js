...
const App = () => {
  ...
  return <div className='app-container'>
    ...
    <form onSubmit={handleAddFormSubmit}>
      ...
      <input type="text" name="phoneNumber" required="required" placeholder='Enter a ph number...' onChange={handleAddFormChange} />
      <input type="email" name="email" required="required" placeholder='Enter a mail id...' onChange={handleAddFormChange} />
